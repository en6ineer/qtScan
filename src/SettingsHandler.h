...
class SettingsHandler : public QObject
{
    ...
    Q_PROPERTY(QStringList methodNames READ methodNames NOTIFY methodsChanged)
...
public:
    ...
    Q_INVOKABLE QStringList getMethodNames() const; // OK, это надо чтобы список в модель ComboBox загружать
    Q_INVOKABLE QStringList getDatabaseNames() const; //
signals:
